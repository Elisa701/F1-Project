🏎️ Overview
The F1 Project is a multi‑page website designed to present key aspects of the Formula 1 world, including teams, drivers, team principals, circuits, standings, and a presentation page.
...
- Circuits page including track images and details.
- Grid Summary summarizing the season grid.
- Contact page with a simple form.
- Presentation page for project explanation.
- Fully written in HTML + CSS, no frameworks.
